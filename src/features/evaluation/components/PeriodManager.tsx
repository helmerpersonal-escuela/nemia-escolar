...
export const PeriodManager = ({ onSelectPeriod, selectedPeriodId }: PeriodManagerProps) => {
                ...
                <form onSubmit={editingPeriod ? handleUpdate : handleCreate} className="mb-6 p-4 bg-gray-50 rounded-lg space-y-4 border border-gray-200">
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => editingPeriod ? setEditingPeriod({ ...editingPeriod, name: e.target.value }) : setNewPeriod({ ...newPeriod, name: e.target.value })}
                            required
                        />
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => editingPeriod ? setEditingPeriod({ ...editingPeriod, start_date: e.target.value }) : setNewPeriod({ ...newPeriod, start_date: e.target.value })}
                                required
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => editingPeriod ? setEditingPeriod({ ...editingPeriod, end_date: e.target.value }) : setNewPeriod({ ...newPeriod, end_date: e.target.value })}
                                required
                            />
                        </div>
                    </div>
